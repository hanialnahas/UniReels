...
function displayNavbar($searchTerm) {
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="collapsibleNavbar">
        ...
        <form action="'; if ($searchTerm == "Titles") {echo "searchTitle.php";} else if ($searchTerm == "Actors") {echo "searchActor.php";} else {echo "";} echo '" method="GET" class="d-flex">
          <input type="text" id="searchBarID" class="form-control me-2 ui-widget" placeholder="Search ' . $searchTerm .'" name="searchbar">
